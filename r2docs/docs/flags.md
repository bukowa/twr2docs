...
This document lists the various flags accepted by the game.
Most of them go into `user.script.txt` and some can be passed directly via CLI to Rome2.exe.
First list is a list of confirmed flags that work, while the second is a full dump.
